# Generated by Django 2.0.7 on 2018-07-05 14:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tt', models.IntegerField(verbose_name='1')),
            ],
            options={
                'verbose_name': '我的博客',
        ...
        migrations.AddField(
            model_name='blog',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='myblog.Category', verbose_name='文章类别'),
        ),
        migrations.AddField(
            model_name='blog',
            name='tag',
